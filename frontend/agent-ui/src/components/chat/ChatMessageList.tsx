        ...
        {!selectedChatId ? (
          <div className="flex flex-1 items-center justify-center">
            <div className="max-w-xl text-center">
              <h1 className="text-3xl font-semibold text-[var(--color-text-main)]">무엇을 도와드릴까요?</h1>
                ...
                <div key={item.message_id} className="w-full">
                  <div className={`mx-auto flex max-w-3xl gap-4 ${isUser ? "justify-end" : "justify-start"}`}>
                    ...
                    <div className={`max-w-[85%] ${isUser ? "order-1" : "order-2"}`}>
                      <div className={`mb-2 text-xs font-medium ${isUser ? "text-right text-[var(--color-text-muted)]" : "text-[var(--color-text-muted)]"}`}>
          ...
          <div className="flex flex-1 items-center justify-center">
            <div className="max-w-xl text-center">
              <h1 className="text-3xl font-semibold text-[var(--color-text-main)]">대화를 시작해보세요</h1>
              <p className="mt-3 text-sm leading-7 text-[var(--color-text-muted)]">
